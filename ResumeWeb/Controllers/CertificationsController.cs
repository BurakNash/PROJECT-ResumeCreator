...
namespace ResumeWeb.Controllers
{
    ...
    public class CertificationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,StartDate,StopDate,Name,Number,Where,Explanation")] Certification certification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,StartDate,StopDate,Name,Number,Where,Explanation")] Certification certification)
        {
            if (ModelState.IsValid)
            {
